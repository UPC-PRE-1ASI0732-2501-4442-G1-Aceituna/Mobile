...
class CategoriaScooterPage extends StatelessWidget {
  const CategoriaScooterPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final categoria = 'Scooter';
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () async {
                  final resultado = await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const CrearVehiculoPage(categoria: 'Scooter'),
                    ),
                  );
      ...
      child: Row(
        children: [
          Container(
            ...
            // Aquí puedes poner una imagen o icono si quieres
          ),
